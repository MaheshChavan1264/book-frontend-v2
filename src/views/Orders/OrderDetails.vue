    ...
    <div class="container">
        ...
        <div v-for="(orderItem, index) in orderItems" :key="index" class="row mt-2 pt-3 justify-content-around">
            ...
            <div class="col-md-3 embed-responsive embed-responsive-16by9">
                <img :src="orderItem.book.imageURL" class="w-100 card-img-top embed-responsive-item">
                <hr/>
            </div>

            <div class="col-md-5 px-3">
                <div class="card-block px-3">
                    <h6 class="card-title" >{{orderItem.book.title}}</h6>
                    <p id="item-price" class="mb-0 font-weight-bold">${{orderItem.book.price}} per unit</p>
