  ...
  <div class="container">
    ...
    >
      ...
      <div class="col-md-3 embed-responsive embed-responsive-16by9">
        <router-link
          :to="{ name: 'ShowBookDetails', params: { id: cartItem.book.id } }"
        >
          <img
      ...
      <!-- display book name, quantity and price -->
        ...
        <div class="card-block px-3">
          ...
          <p id="item-total-price" class="mb-0">
            ...
            <span class="font-weight-bold">
              $ {{ cartItem.book.price * cartItem.quantity }}</span
            >
          </p>
